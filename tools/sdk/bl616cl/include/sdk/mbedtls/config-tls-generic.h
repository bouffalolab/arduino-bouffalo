...
#if defined(CONFIG_MBEDTLS_ENTROPY_POLL)
...
#if defined(CONFIG_MBEDTLS_HAVE_TIME)
...
/* add mbedtls3 feature*/
#if defined (CONFIG_MBEDTLS_X509_TRUSTED_CERT_CALLBACK)
#define MBEDTLS_X509_TRUSTED_CERTIFICATE_CALLBACK
#endif

#if defined (CONFIG_MBEDTLS_SSL_CONTEXT_SERIALIZATION)
#define MBEDTLS_SSL_CONTEXT_SERIALIZATION
#endif

#if defined (CONFIG_MBEDTLS_SSL_CID_PADDING_GRANULARITY)
#define MBEDTLS_SSL_CID_TLS1_3_PADDING_GRANULARITY    CONFIG_MBEDTLS_SSL_CID_PADDING_GRANULARITY
#endif

#if defined (CONFIG_MBEDTLS_ECDH_LEGACY_CONTEXT)
