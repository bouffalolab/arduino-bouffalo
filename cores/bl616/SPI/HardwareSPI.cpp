...
void SPI::beginTransaction(unsigned int speedMaximum, unsigned char dataOrder, unsigned char dataMode)
{
...
unsigned char SPI::transfer(unsigned char val)
{
...
void SPI::setBitOrder(void)
{

}

void SPI::setDataMode(void)
{
