...
extern "C" void mbedtls_pk_init(mbedtls_pk_context *ctx)
{
    if (ctx != nullptr) {
...
extern "C" void mbedtls_pk_free(mbedtls_pk_context *ctx)
{
    (void)ctx;
}

extern "C" const void *mbedtls_pk_info_from_type(mbedtls_pk_type_t type)
{
    (void)type;
    return nullptr;
}

extern "C" int mbedtls_pk_setup(mbedtls_pk_context *ctx, const void *info)
{
    (void)ctx; (void)info;
    return -1;
}

extern "C" mbedtls_pk_type_t mbedtls_pk_get_type(const mbedtls_pk_context *ctx)
{
    (void)ctx;
    return 0;
}

extern "C" int mbedtls_pk_parse_key(mbedtls_pk_context *ctx,
...
extern "C" int mbedtls_pk_parse_public_key(mbedtls_pk_context *ctx,
                                           const unsigned char *key, size_t keylen)
{
...
extern "C" int mbedtls_pk_write_key_der(mbedtls_pk_context *ctx,
...
extern "C" int mbedtls_pk_write_pubkey_der(mbedtls_pk_context *ctx,
                                           unsigned char *buf, size_t size)
{
    (void)ctx; (void)buf; (void)size;
    return -1;
...
extern "C" int mbedtls_pk_sign(mbedtls_pk_context *ctx, int md_alg,
...
extern "C" int mbedtls_pk_verify(mbedtls_pk_context *ctx, int md_alg,
                                 const unsigned char *hash, size_t hash_len,
...
extern "C" int mbedtls_ecp_gen_key(mbedtls_ecp_group_id grp_id, mbedtls_ecp_keypair *key,
                                   int (*f_rng)(void *, unsigned char *, size_t), void *p_rng)
{
...
extern "C" int mbedtls_mpi_write_binary(const mbedtls_mpi *X, unsigned char *buf, size_t buflen)
{
    (void)X; (void)buf; (void)buflen;
    return -1;
}

extern "C" int mbedtls_ecp_group_load(mbedtls_ecp_group *grp, mbedtls_ecp_group_id id)
{
    (void)grp; (void)id;
    return -1;
}

extern "C" int mbedtls_ecp_point_read_binary(const mbedtls_ecp_group *grp,
                                             mbedtls_ecp_point *P,
...
extern "C" int mbedtls_mpi_read_binary(mbedtls_mpi *X, const unsigned char *buf, size_t buflen)
{
    (void)X; (void)buf; (void)buflen;
    return -1;
}

extern "C" void mbedtls_ctr_drbg_init(mbedtls_ctr_drbg_context *ctx)
{
    if (ctx != nullptr) {
        memset(ctx, 0, sizeof(*ctx));
    }
...
extern "C" void mbedtls_ctr_drbg_free(mbedtls_ctr_drbg_context *ctx)
{
    (void)ctx;
}

extern "C" int mbedtls_ctr_drbg_seed(mbedtls_ctr_drbg_context *ctx,
...
extern "C" int mbedtls_ctr_drbg_random(void *p_rng, unsigned char *output, size_t output_len)
{
    (void)p_rng; (void)output; (void)output_len;
    return -1;
}

extern "C" void mbedtls_entropy_init(mbedtls_entropy_context *ctx)
{
    if (ctx != nullptr) {
        memset(ctx, 0, sizeof(*ctx));
    }
...
extern "C" void mbedtls_entropy_free(mbedtls_entropy_context *ctx)
{
    (void)ctx;
}

extern "C" int mbedtls_entropy_func(void *data, unsigned char *output, size_t len)
{
    (void)data; (void)output; (void)len;
    return -1;
}

extern "C" int mbedtls_asn1_get_tag(unsigned char **p, const unsigned char *end,
                                    size_t *len, int tag)
{
...
extern "C" int mbedtls_asn1_write_len(unsigned char **p, unsigned char *start, size_t len)
{
    (void)p; (void)start; (void)len;
    return -1;
}

extern "C" int mbedtls_asn1_write_tag(unsigned char **p, unsigned char *start, unsigned char tag)
{
    (void)p; (void)start; (void)tag;
    return -1;
}

extern "C" int mbedtls_asn1_write_mpi(unsigned char **p, unsigned char *start, const mbedtls_mpi *X)
{
...
extern "C" int mbedtls_pem_write_buffer(const char *header, const char *footer,
