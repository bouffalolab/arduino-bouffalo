...
/* Build adaptation: lfs.h must see LFS_THREADSAFE before struct lfs_config is
 * parsed, otherwise the lock/unlock fields are absent. lfs_port.h defines it
 * too, but this file includes lfs.h first. */
